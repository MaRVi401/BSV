...
// // Jika pengguna sudah login, ambil nama dan ikon pengguna
// $userLoggedIn = isset($_SESSION['user']); // Sesuaikan dengan nama session yang digunakan
// $userName = $userLoggedIn ? $_SESSION['user']['name'] : 'Guest';
// $userIcon = $userLoggedIn ? $_SESSION['user']['icon'] : 'default-user-icon.png'; // Anda bisa mengganti ini sesuai dengan nama file ikon pengguna
?>
